...
![alt text](pc/1.png)
## Выводы
Программа определяет доступ к кабинету на основе словаря. Если кабинет отсутствует, возвращает "None" и "False".
...
![alt text](pc/2.png)
## Выводы
Функция dict_maker добавляет новые пары ключ-значение в словарь, что упрощает его обновление.
...
![alt text](pc/3.png)
## Выводы
Использование кортежей для разбиения строки на символы и их последующей обработки.
...
## Выводы
Функция принимает кортеж с данными и выводит их в отформатированном виде, упрощая работу с входными данными.
...
## Выводы
Функция сортирует кортеж с числами и возвращает его, либо оставляет исходный, если есть нечисловые элементы.
